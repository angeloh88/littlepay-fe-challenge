...
const november: TxRow[] = [
  {
    icon: ShoppingBag,
    iconClass: "text-primary",
    title: "Apple Store Online",
    meta: "Nov 24, 2024 • Electronics",
    status: "Completed",
    statusStyle: "primary",
    amount: "- $1,299.00",
    amountClass: "text-on-surface",
    balance: "Balance: $14,205.50",
  },
  {
    icon: Wallet,
    iconClass: "text-tertiary",
    title: "Monthly Salary - TechCorp",
    meta: "Nov 21, 2024 • Income",
    status: "Completed",
    statusStyle: "primary",
    amount: "+ $8,450.00",
    amountClass: "text-primary",
    balance: "Balance: $15,504.50",
  },
  {
    icon: UtensilsCrossed,
    iconClass: "text-primary",
    title: "Le Bernardin Paris",
    meta: "Nov 18, 2024 • Dining",
    status: "Pending",
    statusStyle: "tertiary",
    amount: "- $412.35",
    amountClass: "text-on-surface",
    balance: "Balance: $7,054.50",
  },
];
    ...
    <div className="group flex items-center justify-between rounded-2xl bg-surface-container-lowest p-4 shadow-sm transition-all hover:bg-white dark:hover:bg-slate-800">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="font-label text-[0.6875rem] text-slate-500">{row.meta}</p>
        </div>
      </div>
      <div className="flex items-center gap-4 sm:gap-8">
        <StatusBadge
          label={row.status}
          variant={row.statusStyle === "primary" ? "primary" : "tertiary"}
        />
  ...
  return (
    <>
      ...
      <footer className="mt-20 flex flex-col items-start justify-between gap-4 border-t border-slate-100 px-10 py-10 text-[0.6875rem] font-medium text-slate-400 sm:flex-row sm:items-center dark:border-slate-800">
        <div>
          © {new Date().getFullYear()} PayQuick Premium Fintech Services. All rights
          reserved.
        </div>
