  ...
  return (
    <div className="px-10 pb-12 pt-28">
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex cursor-pointer items-center justify-between rounded-2xl bg-surface-container-lowest p-5 transition-all duration-200 hover:translate-x-1 dark:bg-slate-900/80">
                    ...
                    <div className="text-right">
                      <p className="text-sm font-bold text-primary">+$5,000.00</p>
              ...
              <div className="group relative h-48 cursor-pointer overflow-hidden rounded-3xl bg-slate-900 p-6 text-white shadow-xl">
                ...
                <div className="relative z-10 flex h-full flex-col justify-between">
                  ...
                  <div className="flex items-end justify-between">
                    <div>
                      <p className="text-[0.625rem] uppercase text-slate-500">Expiry</p>
      ...
      <footer className="mt-20 flex flex-col items-start justify-between gap-4 border-t border-slate-100 pt-10 text-[0.6875rem] font-medium text-slate-400 sm:flex-row sm:items-center dark:border-slate-800">
        <div>
          © {new Date().getFullYear()} PayQuick Premium Fintech Services. All rights reserved.
        </div>
