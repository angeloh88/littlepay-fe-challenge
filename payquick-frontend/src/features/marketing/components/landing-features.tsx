      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-16">
          ...
          <p className="max-w-lg text-on-surface-variant">
            Everything you need to move money at the speed of thought, wrapped
            in an interface that stays out of your way.
          </p>
        </div>
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            <div className="flex flex-col items-center gap-12 md:flex-row">
              <div className="flex-1">
                <div className="mb-6 text-primary-container">
                  <Send className="h-9 w-9" aria-hidden strokeWidth={2} />
                </div>
                <h3 className="mb-4 font-headline text-2xl font-bold">
                  Instant Global Sending
                </h3>
                <p className="mb-8 text-on-surface-variant">
                  Send funds to 140+ countries in seconds. No hidden fees, no
                  weekend delays. Just pure, borderless liquidity.
                </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="rounded-xl bg-surface-container-lowest p-4 editorial-shadow">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="text-sm font-bold">Studio Alpha</div>
                    </div>
                  </div>
                  <button
                    type="button"
          ...
          <div className="flex flex-col justify-between rounded-[1.5rem] bg-primary p-10 text-on-primary editorial-shadow">
            <div>
              <FileQuestion className="mb-6 h-9 w-9" aria-hidden strokeWidth={2} />
              <h3 className="mb-4 font-headline text-2xl font-bold">
                Request with Link
              </h3>
              <p className="leading-relaxed opacity-80">
                Create professional payment requests that your clients can settle
                with a single tap. Beautiful, fast, and secure.
              </p>
            </div>
          ...
          <div className="rounded-[1.5rem] bg-surface-container-lowest p-10 editorial-shadow">
            <div className="mb-6 text-tertiary">
              <LineChart className="h-9 w-9" aria-hidden strokeWidth={2} />
            </div>
            <h3 className="mb-4 font-headline text-2xl font-bold">
              Live Insights
            </h3>
            <p className="text-on-surface-variant">
              Analyze your cash flow with editorial-grade charts that reveal your
              true spending patterns.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center gap-8 overflow-hidden rounded-[1.5rem] bg-surface-container-highest p-10 md:col-span-2 md:flex-row">
            <div className="flex-1">
              ...
              <p className="text-on-surface-variant">
                A singular, crystalline view of every movement across all your
                accounts. One source of truth.
              </p>
            </div>
              ...
              <div className="flex items-center justify-between rounded-xl bg-surface-container-lowest px-6 py-4 editorial-shadow">
                <div className="flex items-center gap-4">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-secondary-fixed text-on-secondary-fixed">
                    <ShoppingBag className="h-5 w-5" aria-hidden strokeWidth={2} />
                  </div>
                  <div>
                ...
                <div className="text-right">
                  <div className="text-sm font-bold">-$1,299.00</div>
              ...
              <div className="flex items-center justify-between rounded-xl bg-surface-container-lowest px-6 py-4 editorial-shadow">
                <div className="flex items-center gap-4">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-tertiary-fixed text-on-tertiary-fixed">
                    <UtensilsCrossed className="h-5 w-5" aria-hidden strokeWidth={2} />
                  </div>
                  <div>
                    <div className="text-sm font-bold">Le Bernardin</div>
                    <div className="text-xs text-on-surface-variant">
                      Dining • Yesterday
                    </div>
                  </div>
                ...
                <div className="text-right">
                  <div className="text-sm font-bold">-$420.50</div>
